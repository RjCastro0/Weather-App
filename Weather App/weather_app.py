...
API_KEY='a3c4f774cb9fd792a3951b5d08084f6f'
geolocator=Nominatim(user_agent="rafael-weatherapp")
...
def get_weather():
    ...
    long_lat.config(text=f"Longitude: {round(location.longitude, 4)}°N, \nLatitude: {round(location.latitude, 4)}°E")
...
text_field=tk.Entry(root, justify='center', width=15, font=('poppins', 25, 'bold'), bg="#203243", border=0, fg="white")
